...
public class ColoredPrint {
    ...
    public static void print(String message) {
        System.out.print(Color.getCode(color) + message + Color.getCode(Color.RESET));
    }

    public static void printf(String message, Object... data) {
        System.out.printf(Color.getCode(color)+ message + Color.getCode(Color.RESET), data);
    }
